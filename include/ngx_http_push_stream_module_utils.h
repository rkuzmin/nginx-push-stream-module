...
ngx_int_t                   ngx_http_push_stream_send_response(ngx_http_request_t *r, ngx_int_t status_code, ngx_str_t *text, const ngx_str_t *content_type, const ngx_str_t *explain_error_message);
